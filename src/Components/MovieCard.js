...
const MovieCard = ( {movies, favourites, handleAddFavourite, handleRemoveFavourite, FavouriteComponent, activeTab} ) => {
    ...
    return ( 
        <>
            {movies.map((movie) => (
                <div className="movies image-container d-flex justify-content-start m-3"  onMouseEnter={() => getMovieVideo(movie)}  key={movie.id}>
